...
class PlanGenerationOutput(BaseModel):
    ...
    goal_color: str = Field(description="Hex color like #3B82F6")
    duration_weeks: int
...
3. A suitable color (hex format, choose from: #3B82F6 blue, #10B981 green, #F59E0B amber, #EF4444 red, #8B5CF6 purple, #EC4899 pink)
